...
// Test Function
console.log(findInvalidCards([valid1, valid2, valid3, valid4, valid5])); // Prints nothing
console.log(findInvalidCards([invalid1])); // Prints the number
// console.log(findInvalidCards(batch)); // Test the mystery number
...
console.log(idInvalidCardCompanies([mystery2])); // Should print ['mastercard']
